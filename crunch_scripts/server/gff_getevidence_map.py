...
def read_getev_flat(getev_flatfile):
    ...
    f_in = getev_flatfile
    if isinstance(getev_flatfile, str) or isinstance(getev_flatfile, unicode):
...
def match_getev(gff_in, getev_flat, transcripts_file=None,
                ...
                progresstracker=None, genetests_filepath="", blosum100_file=None ):
    ...
    blosum_matrix = blosum100( blosum100_file )
